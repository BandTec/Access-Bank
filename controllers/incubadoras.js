...
router.get('/',  function (req, res) {
  ...
  global.conn.request().query`select r.sexo,r.nome,inc.idIncubadora, inc.status from incubadora as inc left join  recemNasc as r on r.idRecemNasc = inc.fkRecemNasc; `
    .then(result => {
